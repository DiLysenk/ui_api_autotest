...
class DropDownMenu(BasePage):
    ...
    def __init__(self, browser, container, name=None, container_with_entity=None, entity_in_menu=None):
    ...
    def set_value(self, value):
        if value is not None:
            ...
            for element in menu:
                ...
                raise AssertionError(f"Элемент с таким названием не найден -- {value}")
